...
public class DataParser {
  ...
  public static Map<CubeFieldsName, Double> parseCubeDataFromStringWithValidating(String dataForParsing)
  ...
  public static Map<CubeFieldsName, Double> parseCubeDataFromString(String dataForParsing)
      throws CustomException {
    if (dataForParsing == null) {
      throw new CustomException("dataForParsing can't be null");
    }
